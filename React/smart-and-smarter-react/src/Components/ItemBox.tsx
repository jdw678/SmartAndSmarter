...
<div className="itembox" style={{margin: '1%', backgroundColor: 'rgba(0,0,0,.5)',border:'solid',borderColor:'#000000', width: '85%', maxWidth: '400px', float: 'right', padding:'16px',display:'block', textAlign:'left'}}>
  <div className="itemboxheader">
      <div style={{float: 'left'}}>

    <div className="iconbox" style={{display: 'inline-flex', maxWidth: 'initial', flexDirection: 'column', alignItems: 'center', flexWrap: 'wrap', whiteSpace:'pre-wrap' }}>

        <div className="rounded relative">
          <a href="https://darkanddarker.wiki.spellsandguns.com/images/thumb/b/b6/Barbarian.png/96px-Barbarian.png" className="image"><img alt="Barbarian.png" src="https://darkanddarker.wiki.spellsandguns.com/images/thumb/b/b6/Barbarian.png/96px-Barbarian.png" decoding="async" width={96} height={105} srcSet="https://darkanddarker.wiki.spellsandguns.com/images/thumb/b/b6/Barbarian.png/96px-Barbarian.png 1.5x" data-file-width={138} data-file-height={151} /></a>
        </div>
    </div>
  </div>
          <div style={{width: '60%', maxWidth: '280px', marginLeft: '15px', height: '100px', justifyContent: 'space-between', display: 'flex', flexDirection: 'column', float: 'left', marginTop: '0px'}}>

              <div className="bold" style={{marginTop: '0px', fontSize: '22px'}}>Barbarian
              </div>
           <div style={{width: '100%', justifyContent: 'space-between', display: 'flex', flexDirection: 'row', fontSize: '17px'}}>
